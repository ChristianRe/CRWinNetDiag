...
namespace WinNetDiag
{
    class NetInfo
    {
        ...
        public string getInfo()
        {
            ...
            Thread t15 = new Thread(delegate () { this.consoleCommandReadOutput("tasklist ", "/SVC /FO LIST ", ref myNetworkInfo); }); int myOSVersion = System.Environment.OSVersion.Version.Major;
